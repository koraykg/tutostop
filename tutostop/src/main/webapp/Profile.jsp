...
<body>
	<div class="container-fluid" >
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-2" style="border-radius: 25px; border: 5px solid #ffffff; background: #e6f7ff; padding: 10px; margin-top: 20px;">
					<div
						style="font-weight: bold; background-color: gainsboro; border: 1px solid gainsboro; border-radius: 25px;">
						<h3 align="center" style="font: 20px arial, sans-serif; margin-top: 5px">Profil Info</h3>
					</div>
